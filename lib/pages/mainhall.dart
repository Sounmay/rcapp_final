        ...
        child: new Column(
          ...
          children: <Widget>[
            ...
            Container(
              padding: EdgeInsets.symmetric(horizontal: 15, vertical: 0),
              child: Text(
                "Present in front of the entrance, the main Banquet Hall is for major occasion s and for big group gatherings, such as musical events, social gatherings, large office parties, marriage receptions, etc \n \n"
                "Capacity - 250 people",
                style: GoogleFonts.inter(
                    color: Colors.black,
