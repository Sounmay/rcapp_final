        ...
        child: new Column(
          ...
          children: <Widget>[
            ...
            Container(
              ...
              child: Text(
                "The Open Tennis court is perfect for sporting events, and for large group gettogethers like Anniversaries, Birthdays, Office picnics etc \n \n"
                "Capacity - 250 people",
                style: GoogleFonts.inter(color: Colors.black, fontSize: MediaQuery.of(context).size.width * 0.05),
              ),
            ),
            SizedBox(
                width: double.infinity,
